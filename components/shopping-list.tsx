...
// Curated food-relevant images matched by product name
...
function getImageUrl(name: string) {
  return PRODUCT_IMAGES[name] ?? `https://images.unsplash.com/photo-1542838132-92c53300491e?w=72&h=72&fit=crop&auto=format`
}
